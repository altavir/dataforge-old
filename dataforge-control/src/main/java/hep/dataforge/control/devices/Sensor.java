...
import static hep.dataforge.control.devices.Sensor.*;
...
@MetaStateDef(
        value = @NodeDef(name = MEASUREMENT_META_STATE, info = "Configuration of current measurement."),
        writable = true
)
@MetaStateDef(
        value = @NodeDef(name = MEASUREMENT_RESULT_STATE, info = "The result of the last measurement in Meta form")
)
...
public abstract class Sensor<T> extends AbstractDevice {
    ...
    public static final String MEASUREMENT_META_STATE = "measurement.meta";
    public static final String MEASUREMENT_RESULT_STATE = "measurement.result";
