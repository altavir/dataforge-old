...
public class IOUtils {
    ...
    public static RowProvider readColumnedData(String fileName, String... names) throws FileNotFoundException {
        return readColumnedData(new File(fileName), names);
    }

    public static RowProvider readColumnedData(File file, String... names) throws FileNotFoundException {
        return readColumnedData(new FileInputStream(file));
    }

    public static RowProvider readColumnedData(InputStream stream, String... names) {
