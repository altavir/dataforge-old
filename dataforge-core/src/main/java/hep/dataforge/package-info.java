 ...
 * Менеджер (любой кроме Global) является динамическим объектом, то есть может быть инстанцирован несколько раз
 * (удобно в плане многопоточности, кстати в этом же плане все менеджеры должны быть сделаны конкурентными). 
 * Имеется один статический Global, содержащий один или несколько экземпляров каждого менеджера.
