...
class DataSet<T: Any> internal constructor(
    ...
    override fun optNode(nodeName: String): DataNode<out T>? {
        val builder = DataSetEditor(type).apply {
            name = nodeName
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun edit(): DataSetEditor<Any> {
            return DataSetEditor(Any::class.java)
        }
    }

}

class DataSetEditor<T: Any> internal constructor(type: Class<T>) : DataNodeEditor<T>(type) {
