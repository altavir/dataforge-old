...
import hep.dataforge.fitting.FitEngine;
...
import static hep.dataforge.fitting.FitTask.TASK_COVARIANCE;
import static hep.dataforge.fitting.FitTask.TASK_RUN;
import static hep.dataforge.fitting.FitTask.TASK_SINGLE;
...
public class MINUITFitEngine implements FitEngine {
     ...
     * runHesse.</p>
     *
     * @param state a {@link hep.dataforge.fitting.FitState} object.
     * @param task a {@link hep.dataforge.fitting.FitTask} object.
     * @param log
     * @return a {@link hep.dataforge.fitting.FitTaskResult} object.
     */
