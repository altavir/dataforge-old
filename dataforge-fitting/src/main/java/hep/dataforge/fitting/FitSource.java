...
import hep.dataforge.fitting.parametric.DerivativeCalculator;
...
public class FitSource{
     ...
     *
     */
    protected final ParametricValue prior;


    public FitSource(Table dataSet, Model model, ParametricValue prior) {
