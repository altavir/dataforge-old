...
public class FitState extends FitSource {
     ...
     * @param model a {@link hep.dataforge.fitting.models.Model} object.
     * @param pars a {@link hep.dataforge.fitting.ParamSet} object.
     * @param covariance a {@link hep.dataforge.maths.NamedMatrix} object.
     * @param interval a {@link hep.dataforge.fitting.IntervalEstimate}
     * object.
     * @param prior a {@link hep.dataforge.fitting.parametric.ParametricValue} object.
     */
    public FitState(Table dataSet, Model model, ParamSet pars,
     ...
     *
     * @return a {@link hep.dataforge.fitting.IntervalEstimate} object.
     */
