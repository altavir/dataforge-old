            ...
            splitpane(orientation = Orientation.HORIZONTAL) {
                ...
                sidebar = vbox {
                    button(text = "Frame config") {
                        ...
                        action {
                            displayConfigurator("Plot frame configuration", frame, Descriptors.forType(frame::class))
                        }
                    }
                    treeview<Plottable> {
                        minWidth = 0.0
                        ...
                        cellFormat { item ->
                            graphic = hbox {
                                ...
                                button("...") {
                                    minWidth = 0.0
                                    action {
                                        displayConfigurator(item.title + " configuration", item, Descriptors.forType(item::class))
                                    }
                                }
