...
public class MnPlot {
            ...
            if (isp1 <= nxypt) {
                ...
                for (k = isp1; k <= nxypt; ++k) {
                    ...
                    if (cline.charAt(ix - 1) != '.' && cline.charAt(ix - 1) != ' ') {
                        if (cline.charAt(ix - 1) == chpt.charAt(k - 1)) {
                            continue;
                        }
                        overpr = true;
     ...
     * @param points a {@link java.util.List} object.
     */
    public void plot(double xmin, double ymin, List<Range> points) {
