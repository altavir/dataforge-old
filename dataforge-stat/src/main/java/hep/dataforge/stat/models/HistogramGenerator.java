...
public class HistogramGenerator implements Generator {
     ...
     * @param source a {@link hep.dataforge.stat.models.HistogramModel} object.
     * @param params a {@link hep.dataforge.stat.fit.ParamSet} object.
     */
    ...
    /** {@inheritDoc} */
    @Override
    public RowProvider generateData(Iterable<DataPoint> config) {
     ...
     * @return
     */
    public RowProvider generateUniformHistogram(double begin, double end, int binNumber) {
        assert end > begin;
        ListTable.Builder res = new ListTable.Builder(names);
        DataPoint bin;
